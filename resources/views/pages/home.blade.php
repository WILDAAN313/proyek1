        ...
        <div class="artikel-section mt-4">
            ...
            <div class="card mb-4 shadow-sm p-3 rounded-4 d-flex flex-row align-items-center artikel-card">
                ...
                <div class="card-body text-start">
                    ...
                    <p class="card-text text-muted">
                        Sayuran hijau kaya akan serat, vitamin, dan mineral yang membantu menjaga sistem kekebalan tubuh
                        serta menurunkan risiko penyakit kronis.
                    </p>
            ...
            <div class="card mb-4 shadow-sm p-3 rounded-4 d-flex flex-row align-items-center artikel-card">
                ...
                <div class="card-body text-start">
                    ...
                    <p class="card-text text-muted">
                        Salad buah adalah pilihan tepat untuk menjaga berat badan. Kombinasi buah segar memberikan energi
                        alami dan antioksidan tinggi.
                    </p>
                    <a href="/artikel" class="btn btn-outline-success btn-sm">Baca Selengkapnya</a>
                </div>
            </div>
            ...
            <div class="card mb-4 shadow-sm p-3 rounded-4 d-flex flex-row align-items-center artikel-card">
                ...
                <div class="card-body text-start">
                    ...
                    <p class="card-text text-muted">
                        buah buahan tidak hanya menjaga kebugaran tubuh tetapi juga meningkatkan mood dan memperkuat sistem
                        imun.
                    </p>
                    <a href="/artikel" class="btn btn-outline-success btn-sm">Baca Selengkapnya</a>
                </div>
