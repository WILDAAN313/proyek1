    ...
    <div class="profile-wrapper">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="name" class="form-control editable" value="{{ Auth::user()->nama_lengkap }}"
                    readonly>
            </div>

            <div class="col-md-6">
                <label class="form-label">Email</label>
                <input type="text" name="email" class="form-control editable" value="{{ Auth::user()->email }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="phone" class="form-control editable" value="{{ Auth::user()->phone }}"
                    readonly>
            </div>

            <div class="col-md-6">
                <label class="form-label">Tanggal Lahir</label>
                <input type="date" name="birthdate" class="form-control editable" value="{{ Auth::user()->birthdate }}"
                    readonly>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="text" name="weight" class="form-control editable" value="{{ Auth::user()->weight }}"
                    readonly>
            </div>

            <div class="col-md-6">
                <label class="form-label">Tinggi Badan (cm)</label>
                <input type="text" name="height" class="form-control editable" value="{{ Auth::user()->height }}"
                    readonly>
            </div>
        </div>
